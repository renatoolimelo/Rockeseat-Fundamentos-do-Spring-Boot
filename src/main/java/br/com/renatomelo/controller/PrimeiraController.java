package br.com.renatomelo.controller;
...
public class PrimeiraController {
	...
	public ResponseEntity<Object> metodoResponseEntity2(@PathVariable long id) {
		Usuario usuario = new Usuario("Renato", "Uninove");
		if (id > 5) {
	...
	record Usuario(String username, String escola) {
	}
